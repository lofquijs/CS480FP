...
//DUPLICATES
   ...
   * @param geocoder -> Geocoder to be used
   */
  public GeocodeDialog(final JFrame owner, final Geocoder geocoder)
  {
    ...
    populate(categoryField, new String[] {"Aly","Arc","Ave","Blvd","Br","Brg","Byp","Cir","Cres",
        "Cswy","Ct","Ctr","Cv","Dr","Expy","Fwy","Grd","Hwy","Ln","Loop","Mal","Pass","Path","Pike",
  ...
  public void actionPerformed(final ActionEvent evt)
  {
    ...
    {
      String spacer = "\"";
      JOptionPane.showMessageDialog(this, spacer +numberField.getText() 
          + spacer + " is not a valid street number!",
