...
/**
 * Implementation of the BellmanFord Label setting algorithm for CS480 Final
 * Project.
 * 
...
public class BellmanFord extends AbstractShortestPathAlgorithm {
	 ...
	 * 
	 * @param labels candidate label manager to use.
	 */
	 ...
	 * 
	 * @param id  intersection to update
	 * @param net streetnetwork to use
	 */
