...
/**
 * PermanentLabelHeap manages labels for intersections in a street network using
 * a heap structure.
 * 
...
public class PermanentLabelHeap extends AbstractLabelManager implements PermanentLabelManager {
	...
	/**
	 * Constructs a PermanentLabelHeap with the specified branching factor and
	 * network size.
	 *
	 * @param d           the branching factor of the heap (e.g., 2 for a binary
	 *                    heap)
	 * @param networkSize the total number of intersections in the network
	 */
	 ...
	 * 
	 * @param segment the street segment used for updating labels
	 */
	@Override
	 ...
	 *
	 * @return the Label with the smallest value in the heap, or null if the heap is
	 *         empty
	 */
	@Override
	 ...
	 *
	 * @param intersectionID the id of the intersection to mark as permanent
	 */
	@Override
	 ...
	 *
	 * @param intersectionId the identifier for the intersection
	 ...
	 *
	 * @param intersectionId the id to insert into the heap
	 */
	 ...
	 *
	 * @param i the index within the heap array to adjust
	 */
	 ...
	 *
	 * @param i the starting index for heapifying down.
	 */
	 ...
	 *
	 * @param pos the index in the heap array to remove.
	 */
